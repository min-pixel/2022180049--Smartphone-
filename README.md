...
| **6주차** | 5/13 ~ 5/19    | - 맵 개선작업 |
| **7주차** | 5/20 ~ 5/26    | - 적 충돌처리 개선  |
| **8주차** | 5/27 ~ 6/2     | - 적 충돌처리 개선 2 |
| **9주차** | 6/3 ~ 6/9     | - 스탯 강화 시스템 구현 (이동속도, 공격력 등 5종 × 3단계)<br>- 스탯 확인 UI 구현<br>- 스킬 3종 구현|
| **10주차** | 6/10 ~ 6/16     | - 보스 몬스터 1종 구현 (고유 체력, 등장 타이머 조건 등)<br>- 게임 오버 / 클리어 조건 처리<br>- 결과 화면 UI 구현 |
